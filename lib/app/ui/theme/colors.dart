...
Color primaryColor = rgb(254, 190, 0);
Color primaryColorDark = rgb(254, 190, 0);

Color secondaryColor = rgb(254, 190, 0);
Color secondaryColorDark = rgb(254, 190, 0);

Color fontColor = rgb(26, 26, 26);
Color fontColorDark = rgb(255, 255, 255);

Color backgroundColor = rgb(246, 246, 246);
Color backgroundColorDark = rgb(0, 0, 0);
